...
ElevatorPID::ElevatorPID() : PIDSubsystem("ElevatorPID", -1.0, 0.0, 0.0) {
	...
	lifter = RobotMap::elevatorPIDLifter;
	liftEncoder = RobotMap::elevatorPIDLiftEncoder;
	liftBrake = RobotMap::elevatorPIDLiftBrake;
	botSwitch = RobotMap::elevatorPIDBotSwitch;
	topSwitch = RobotMap::elevatorPIDTopSwitch;
...
void ElevatorPID::InitDefaultCommand() {
	...
	SetDefaultCommand(new ReadJoystickElevator());
